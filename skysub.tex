...
In this section we have analyzed the performance of our flat field, median background subtraction and photometric calibration procedures that were outlined in \Fig{flowchart}.
...
To summarize the first half of this work, we have demonstrated that \texttt{NIGHT} sky flats are appropriate for our application, and the impact of thermal background and scattered light on flat fields and zero-points are negligible compared to background uncertainties due to NIR sky glow.
