...
\begin{figure*}[t]
    \centering
        \includegraphics[width=6in]{figs/scalar_residual_sb_net}
...
\begin{figure*}[t]
    \centering
        \includegraphics[width=6in]{figs/scalar_relresidnet}
...
\begin{itemize}
	\item Comparison to Montage's solution, e.g. figure \ref{fig:montage_planar_mosaics} and a percent difference map.
	\item Bootstrap analysis of scalar offset solutions (will result in an RMS pixel map of mosaic constructed from different initial offsets.)
\end{itemize}
