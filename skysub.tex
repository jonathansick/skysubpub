...
Note that the NM algorithm will converge into any local minimum without necessarily seeking the global minimum of the objective function.
We resolve this issue with two practices: ensuring re-convergence, and sampling different starting conditions.

The practice of of ensuring reconvergence in a downhill optimization is suggested by \cite{Press:2007}.
% As suggested in \cite{Press:2007}, we restart the converged simplex to ensure reconvergence and protect against false minima.
...
A second practice we employ to find global minima is start start several independent NM simplex optimizations from random starting points in parameters space.
