...
Real-time sky flats, on the other hand, do produce flat median sky images to within a high accuracy.
...
Generally, the axis symmetry of the sky flat evolution, along with continuity across detectors, is further evidence of mechanical instabilities that change the WIRCam illumination function on scales of minutes.
...
Though we have determined that real-time sky flats are crucial for tracking the WIRCam flat fielding function, we are also confronted with the practical limit for WIRCam flat fielding.
