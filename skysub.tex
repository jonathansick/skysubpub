...
We present our WIRCam reduction pipeline and performance analysis as a template for future NIR observers needing wide-area surface brightness maps with sky-target nodding, and give specific recommendations for the improvement of all NIR wide-field imaging methods.
\end{abstract}
