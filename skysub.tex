...
\subsection{Analysis of Sky Flat Fielding and Background Subtraction Methods}

In this section we have described how we calibrate the surface brightness shapes of WIRCam images by applying sky flat fields and subtracting a median background shape.
Near-infrared sky flat fields are fraught with \emph{additive} contaminants from thermal emission and scattered light.
Although we regard a perfect near-infrared flat field as unattainable, we can test which flat field prescription (\texttt{QRUN}, \texttt{NIGHT} or \texttt{FW100K}) performs best, and assess whether the final quality of our NIR M31 mosaics are limited by uncertainties from flat fielding or from ST-nodding sky subtraction uncertainties.

\subsubsection{Detector-to-Detector zeropoint consistency}
