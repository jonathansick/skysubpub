...
In this section, we introduce our data reduction pipeline for producing  with CFHT/WIRCam mosaics of M31.
While CFHT distributes calibrated WIRCam data products, we haven chosen to replace much of their data reduction recipes with our to optimize and explore the limitations of wide-field NIR surface brightness maps.
