...
\begin{figure}[t]
    \centering
        ...
        \caption{Surface brightness difference maps between our simplex scalar-fit mosaics (\Fig{scalar_mosaics}) and scalar-fit mosaics generated by \sw{Montage} (see \Fig{montage_planar_mosaics}).}
