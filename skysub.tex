...
These clearly point out flaws in the flat field itself, since the surface brightness residuals are proportional to surface brightness.
...
Casual comparison between \Fig{frame_residuals_M31-37_Ks_fw100k_medsky} and \Fig{frame_residuals_M31-37_Ks_QRUN} shows on slight gains in absolute flat fielding performance from RT sky flats.
