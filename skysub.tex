...
To proceed, we must accept that our sky flats are not purely proportional calibrations, possibly up to the limit of a few percent, and instead are a first step in our combined flux calibration and background subtraction pipeline.
