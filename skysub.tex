...
% \title{ANDROIDS I. New Insights in Near-IR Photometry of Extended Sources from the Andromeda Galaxy (M31)}
\title{ANDROIDS I. New Insights in Extremely Wide-Field Near-IR Surface Photometry\\ with the Andromeda Galaxy (M31)}
...
A wealth of datasets exist for M31, however, none provide simultaneous observations of M31's resolved and integrated NIR light.
...
These background fluctuations present a lower limit in the surface brightness uncertainty across a WIRCam frame since they appear to be caused by sky glow variations in target images that cannot be fully corrected with median sky subtraction.
