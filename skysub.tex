...
The mean surface brightness difference between blocks in our mosaic can be reduced from 1\% to 0.1\% of the background brightness by introducing scalar sky offsets to each image that optimize surface brightness continuity across overlapping pairs of images.
...
Rather the surface brightness shapes of WIRCam frames are uncertain by 0.3\% of the background level due to stochastic differences in background shape in sky and disk fields.
This limited background shape accuracy prevents planar sky offsets, made with the \sw{Montage} package, from improving the mosaic's surface brightness stability.
