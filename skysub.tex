...
At the limit, our \texttt{FW100K} flats are updated with moving windows of approximately 30~minutes.
Here we investigate the nature of evolution in the `real-time` \texttt{FW100K} flats throughout a night.
In doing so, we can assess whether sky flat evolution is driven by proportional effects, or additive contamination from a thermal background or scattered light.
