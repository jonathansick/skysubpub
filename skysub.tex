...
\begin{enumerate}
  \item Some days are more stable than others (\eg 54317 and 54318 in M31-1 \texttt{QRUN} and \texttt{FW100k}). On 54317 the disk residuals were exceptionally small ($\Delta m \lesssim 0.1$~mag), while on 54318 the residuals bloomed to $Delta m \sim 0.5$ centre-to-edge. We see no discernible different between \texttt{FW100K} and \texttt{QRUN} sky flats.
\end{enumerate}

\begin{figure*}[p]
\centering
\subfloat[M31-1 $K_s$ on 54317 (\texttt{QRUN} flat).]{
\includegraphics[width=0.46\textwidth]{figs/frame_residuals/M31-1_Ks_queuesky_medsky_54317.pdf}
\label{fig:m311Ks_frameresiduals_54317_qrun}}
\qquad
\subfloat[M31-1 $K_s$ on 54318 (\texttt{QRUN} flat).]{
\includegraphics[width=0.46\textwidth]{figs/frame_residuals/M31-1_Ks_queuesky_medsky_54318.pdf}
\label{fig:m311Ks_frameresiduals_54318_qrun}}

\subfloat[M31-1 $K_s$ on 54317 (\texttt{FW100K} flat).]{
\includegraphics[width=0.46\textwidth]{figs/frame_residuals/M31-1_Ks_fw100k_medsky_54317.pdf}
\label{fig:m311Ks_frameresiduals_54317_fw100k}}
\qquad
\subfloat[M31-1 $K_s$ on 54318 (\texttt{FW100K} flat).]{
\includegraphics[width=0.46\textwidth]{figs/frame_residuals/M31-1_Ks_fw100k_medsky_54318.pdf}
